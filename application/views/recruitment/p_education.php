...
<script>
    ...
    jQuery(function($) {
        ...
        jQuery("#grid-table").jqGrid({
            url: '<?php echo WS_JQGRID."recruitment.p_education_controller/read"; ?>',
            datatype: "json",
            mtype: "POST",
            colModel: [
                {label: 'ID', name: 'education_id', key: true, width: 5, sorttype: 'number', editable: true, hidden: true},
                {label: 'Jenjang Pendidikan',name: 'education_code',width: 350, align: "left",editable: true,
                    editoptions: {
                        size: 30,
                        maxlength:32
                    },
            ...
            onSelectRow: function (rowid) {
                var celValue = $('#grid-table').jqGrid('getCell', rowid, 'education_id');
            ...
            editurl: '<?php echo WS_JQGRID."recruitment.p_education_controller/crud"; ?>',
