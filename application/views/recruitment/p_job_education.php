    		            ...
    		            <div class="row">
    		                <div class="col-xs-12">     
                                <div class="alert alert-block alert-success">
                                    ...
                                    <i class="ace-icon fa fa-lightbulb-o green"></i> Jika lowongan yang bersangkutan terbuka untuk semua jenjang pendidikan, maka syarat pendidikan tidak perlu diisi.
                                </div>
                            </div>
                        </div>
    		            <div class="row">
