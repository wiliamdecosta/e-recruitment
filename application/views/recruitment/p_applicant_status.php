<div id="breadcrumbs" class="breadcrumbs">
    <div id="breadcrumbs" class="breadcrumbs">
	    <ul class="breadcrumb">
            ...
            <li class="active">Status Pelamar</li>
	    </ul><!-- /.breadcrumb --
...
<script>
    ...
    jQuery(function($) {
        ...
        jQuery("#grid-table").jqGrid({
            url: '<?php echo WS_JQGRID."recruitment.p_applicant_status_controller/read"; ?>',
            datatype: "json",
            mtype: "POST",
            colModel: [
                {label: 'ID', name: 'applicant_status_id', key: true, width: 5, sorttype: 'number', editable: true, hidden: true},
                {label: 'Status Pelamar',name: 'code',width: 150, align: "left",editable: true,
                    editoptions: {
                        size: 30,
                        maxlength:32
                    },
            ...
            editurl: '<?php echo WS_JQGRID."recruitment.p_applicant_status_controller/crud"; ?>',
