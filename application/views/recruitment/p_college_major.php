<div id="breadcrumbs" class="breadcrumbs">
    <div id="breadcrumbs" class="breadcrumbs">
	    <ul class="breadcrumb">
            ...
            <li class="active">Jurusan Perkuliahan</li>
	    </ul><!-- /.breadcrumb --
...
<script>
    ...
    jQuery(function($) {
        ...
        jQuery("#grid-table").jqGrid({
            url: '<?php echo WS_JQGRID."recruitment.p_college_major_controller/read"; ?>',
            datatype: "json",
            mtype: "POST",
            colModel: [
                {label: 'ID', name: 'major_id', key: true, width: 5, sorttype: 'number', editable: true, hidden: true},
                {label: 'Jurusan Perkuliahan',name: 'major_code',width: 150, align: "left",editable: true,
                    editoptions: {
                        size: 30,
                        maxlength:32
                    },
                ...
                {label: 'Keterangan',name: 'major_description',width: 200, align: "left",editable: true,
                    edittype:'textarea',
                    editoptions: {
                        rows: 2,
                        cols:50
            ...
            editurl: '<?php echo WS_JQGRID."recruitment.p_college_major_controller/crud"; ?>',
            caption: "Jurusan Perkuliahan"
