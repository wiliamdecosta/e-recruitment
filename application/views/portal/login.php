                            ...
                            <div class="col-md-6 col-md-offset-3">
                                <div class="featured-box featured-box-primary align-left mt-xlg">
                                    <div class="box-content">
                                        <h4 class="heading-primary text-uppercase mb-md">Login Recruitment</h4>
                ...
                <script type="text/javascript">
                    ...
                    $("#formLogin").submit(function(e) {
                        ...
                        if($("#formLogin").valid() == true){
                            var url = "<?php echo site_url('login/login_action');?>"; // the script where you handle the form input.
                            $.ajax({
                                type: "POST",
                                url: url,
                                dataType : 'json',
                                ...
                                success: function(data)
                                {
                                    if(data.success == true){
                                        window.location = '<?php echo base_url('applicant/index');?>';
                                    }else{
