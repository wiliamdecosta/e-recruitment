...
<head>
    ...
    <link rel="stylesheet" href="<?php echo base_url(); ?>assets/vendor/rs-plugin/css/layers.css" media="screen">
    <link rel="stylesheet" href="<?php echo base_url(); ?>assets/vendor/rs-plugin/css/navigation.css" media="screen">
        ...
        <div class="header-body">
                    ...
                    <div class="header-column">
                        <div class="header-logo">
                            <a href="<?php echo base_url(); ?>">
                                <img alt="Porto" width="511" height="74" data-sticky-width="82" data-sticky-height="40"
                        ...
                        <ul class="header-extra-info hidden-xs">
                            <li>
                                <div class="feature-box feature-box-style-3">
                                    ...
                                    <div class="feature-box-info">
                                        <h4 class="mb-none">022-2509030</h4>
                                        <p>
                            ...
                            <li>
                                <div class="feature-box feature-box-style-3">
                                    ...
                                    <div class="feature-box-info">
                                        <h4 class="mb-none">recruitment@pambdg.co.id</h4>
                                        <p>
                                            <small>Email</small>
                                        </p>
                                    </div>
            ...
            <div class="header-container header-nav header-nav-bar header-nav-bar-primary">
                <div class="container">
                    ...
                    <div class="header-nav-main header-nav-main-light" style="float: right">
                        <nav>
                                        ...
                                        <form id="formRegister" method="post">
                                            ...
                                            <div class="row">
                                                <div class="form-group">
                                                    <div class="col-md-12">
                                                        <label>Alamat *</label>
                                                        <textarea maxlength="5000" data-msg-required="Please enter your message." rows="5" class="form-control valid" name="message" id="message" required="" aria-required="true" aria-invalid="false"></textarea>
                                                    </div>
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <button type="submit" class="btn btn-primary pull-right mb-xl" id="btnRegister"> Register </button
                                                </div>
                                            </div>
                                        </form>
                                    </div>
