<div class="page-content">
    <div class="row" style="display:none;" id="application_role_form_add_edit">
        <div class="col-xs-12">
            <form class="form-horizontal" role="form" id="application_role_form">
                ...
                <?php
    		        ...
    		        $table->setCriteria(" p_application_id NOT IN (SELECT p_application_id FROM recruitment.p_application_role WHERE p_role_id = ".getVarClean('p_role_id','int',0).") ");  
