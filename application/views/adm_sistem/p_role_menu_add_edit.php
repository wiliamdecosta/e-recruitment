<div class="page-content">
    <div class="row" style="display:none;" id="role_menu_form_add_edit">
        <div class="col-xs-12">
            <form class="form-horizontal" role="form" id="role_menu_form">
    
                <?php
                    $ci =& get_instance();
                    $sql = "SELECT * FROM recruitment.v_p_menu_tree WHERE p_application_id = ".getVarClean('p_application_id','int',0)."
                            AND p_menu_id NOT IN (SELECT p_menu_id FROM recruitment.p_role_menu WHERE p_role_id = ".getVarClean('p_role_id','int',0).")";
