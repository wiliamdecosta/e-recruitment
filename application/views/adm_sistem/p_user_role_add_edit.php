<div class="page-content">
    <div class="row" style="display:none;" id="user_role_form_add_edit">
        <div class="col-xs-12">
            ...
            <form class="form-horizontal" role="form" id="user_role_form">
                
                <?php 
                    $ci =& get_instance(); 
                    $ci->load->model('adm_sistem/p_role');
    		        $table = $ci->p_role;
    		        $table->setCriteria("role.p_role_id NOT IN (SELECT p_role_id FROM recruitment.p_user_role WHERE p_user_id = ".getVarClean('p_user_id','int',0).")");
