...
class P_application extends Abstract_model {
	...
	public $table			= "recruitment.p_application";
	...
	public $fromClause 		= "recruitment.p_application as application";

	public $refs			= array('recruitment.p_application_role' => 'p_application_id',
	                                 'recruitment.p_menu' => 'p_application_id');
	...
	function validate() {
		...
		if($this->actionType == 'CREATE') {
			//do something
			$this->record['p_application_id'] = $this->generate_id('recruitment','p_application','p_application_id');
