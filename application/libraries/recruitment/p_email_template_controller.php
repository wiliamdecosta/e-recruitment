...
/**
* Json library
* @class P_email_template_controller
...
class P_email_template_controller {
    ...
    function read() {
        ...
        $sidx = getVarClean('sidx','str','email_tpl_id');
    	...
    	try {
            ...
            // Filter Table
            $req_param['where'] = array("email_template.job_posting_id = ".$job_posting_id);
